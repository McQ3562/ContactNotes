...
public class DB_ConnectionString
    {
        ...
        private static string ApplicatioName = "Contact_Notes";
        ...
        public static string GetContactNotesConnectionString()
        {
            ConnectionStringSettings awareConStr = ConfigurationManager.ConnectionStrings["ContactNotes"];
